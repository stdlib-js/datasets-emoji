...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/datasets-emoji/tags). For example,

```javascript
emoji = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-emoji@v0.1.0-umd/browser.js' )
```
